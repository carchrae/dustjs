...
dust.fixDotPathReference = function(yes) {
  if (yes){ 
    Context.prototype.getPath = Context.prototype.getPath2;
  } 
  else {
  	Context.prototype.getPath = Context.prototype.getPath1;
  }
};
...
Context.prototype.getPath1 = function(cur, down) {
...
Context.prototype.getPath2 = function(cur, down) {
  var ctx = this.stack,
      len = down.length,      
